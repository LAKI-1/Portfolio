...
if(document.querySelector('.iTyped')) {
    window.ityped.init(document.querySelector('.iTyped'), {
        strings: ["I'm a CS Undergraduate", "I'm a web developer", "I'm a public speaker", 'I Love Machine Learning', 'I Love leadership'],
        loop: true
    });
}
...
if(navTogglerBtn && aside) {
    ...
    function asideSectionTogglerBtn()
    {
        ...
        // Toggle open class for all sections only for layout purposes
...
document.addEventListener('DOMContentLoaded', function() {
    if (window.innerWidth < 1200) {
        // Make sure the nav toggler is visible
        if(navTogglerBtn) {
